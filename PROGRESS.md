...
| --- | ---------------------------- | --------------------------------------------------------------------- | ----------- | --- |
| 1   | `chore/cleanup-logs`         | Untrack root log files + tighten `.gitignore` (incl. pycache)         | in progress | -   |
| 1.5 | `chore/untrack-data`         | Untrack `data/test/**.tif` and `data/split/*.json` (working copy kept)| planned     | -   |
